...
function Navbar() {
    return (
        <div className="container-fluid fixed-top px-0 wow fadeIn bg-dark opacity-75" data-wow-delay="0.1s">
            ...
            <nav className="navbar navbar-expand-lg navbar-dark py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
                <Link to={"/"} className="navbar-brand ms-4 ms-lg-0">
                    <h1 className="fw-bold text-primary  m-0">Vedshree Ayurveda</h1>
                </Link>
                <button type="button" className="navbar-toggler me-4" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
                    <span className="navbar-toggler-icon"></span>
                </button>
                <div className="collapse navbar-collapse" id="navbarCollapse">
                    <div className="navbar-nav ms-auto p-4 p-lg-0 bg-dark">
                        <Link to={"/"} className="nav-item nav-link active">Home</Link>
                        <Link to={"/About"} className="nav-item nav-link">About Us</Link>
                        <Link to={"/Product"} className="nav-item nav-link">Products</Link>
                        {/* <div className="nav-item dropdown">
                        <a href="#" className="nav-link dropdown-toggle bg-dark" data-bs-toggle="dropdown">Pages</a>
